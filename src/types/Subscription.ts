...
// If you need a real Paddle subscription payment with checkout page, customer portal, webhook, etc.
...
export type PlanDetails =
  | {
    isPaid: true;
    plan: PricingPlan;
    paddleDetails: IPaddleSubscription;
  } | {
    isPaid: false;
    plan: PricingPlan;
    paddleDetails?: undefined;
  };
